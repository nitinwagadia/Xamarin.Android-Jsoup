                ...
                case StartTag:
                    ...
                    if (name.equals("a")) {
                        ...
                        for (Attribute attribute : startTag.getAttributes()) {
                            if (!html.hasAttr(attribute.getKey().toString()))
                        ...
                        if (stack.size() == 1 || (stack.size() > 2 && !stack.get(1).nodeName().equals("body"))) {
                            ...
                            for (Attribute attribute : startTag.getAttributes()) {
                                if (!body.hasAttr(attribute.getKey().toString()))
                        ...
                        for (Attribute attr : startTag.attributes) {
                            if (!StringUtil.inSorted(attr.getKey().toString(), Constants.InBodyStartInputAttribs))
