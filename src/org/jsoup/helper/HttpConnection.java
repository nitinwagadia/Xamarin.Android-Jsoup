...
public class HttpConnection implements Connection {
    ...
    public static class HttpBase<T extends Base> implements Base<T> {
    ...
    public static class HttpRequest extends HttpBase<Request> implements Request {
    ...
    public static class HttpResponse extends HttpBase<Response> implements Response {
        ...
        static Response execute(Request req, HttpResponse previousResponse) throws IOException {
            ...
            try {
                ...
                if (contentType != null && xmlContentTypeRxp.matcher(contentType).matches()) {
                    ...
                    if (req instanceof HttpRequest && !((HttpRequest) req).parserDefined) {
    ...
    public static class HttpKeyVal implements KeyVal {
        private String key;
